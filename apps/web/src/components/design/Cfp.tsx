...
export type CfpData = {
  ...
  readonly onAbstract: (event: React.SyntheticEvent) => void;
  ...
  readonly onFramework: (event: React.SyntheticEvent) => void;
  readonly onName: (event: React.SyntheticEvent) => void;
  readonly onTitle: (event: React.SyntheticEvent) => void;
  readonly p0: boolean;
  readonly p1: boolean;
  readonly p2: boolean;
  readonly p3: boolean;
  ...
  readonly wordCount: React.ReactNode;
