...
export type EvaluationsData = {
  ...
  readonly editR2: (event: React.SyntheticEvent) => void;
  ...
  readonly nudgeSlow: (event: React.SyntheticEvent) => void;
  ...
  readonly previewR2: (event: React.SyntheticEvent) => void;
