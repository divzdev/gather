...
export type EvaluationsData = {
  /* `addEval`, `evalEmpty` and `canRemind` are hand-bound; the create-round
   * card was removed in favour of a SideDrawer owned by the page, so its five
   * props (`createRound`, `newName`, `onNewName`, `newBlindLabel`,
   * `togNewBlind`) are gone with it. */
  readonly addEval: (event: React.SyntheticEvent) => void;
  ...
  readonly evalEmpty: React.ReactNode;
...
export function Evaluations({ d }: { d: EvaluationsData }) {
  return (
    <DesignMotion css={HOVER_CSS}>
      <div
        data-screen-label="Evaluation plans"
        style={{
          display: "grid",
        ...
        >
          ...
          <div style={{ flex: "1", overflowY: "auto", padding: "20px 28px 80px" }}>
            ...
            >
              ...
              >
                who scores what, by when, under which rules
              </span>{" "}
              <div style={{ flex: "1" }}></div>{" "}
              <div
                style={{
              ...
              >
                ...
                <button
                  ...
                  style={{
                    ...
                    background: d.pB.bg,
                    color: d.pB.fg,
                    font: `${d.pB.wt} 12px 'IBM Plex Sans',sans-serif`,
                    boxShadow: d.pB.sh,
                  }}
                >
                  Plans
                ...
                <button
                  ...
                  style={{
                    ...
                    background: d.eB.bg,
                    color: d.eB.fg,
                    font: `${d.eB.wt} 12px 'IBM Plex Sans',sans-serif`,
                    boxShadow: d.eB.sh,
                  }}
                >
                  Evaluators
            ...
            >
              ...
              <button
                ...
                style={{
                  ...
                  padding: "14px 16px",
                  borderRadius: "14px",
                  border: `1px solid ${d.tPlans.bd}`,
                  background: "var(--cd,#FFFFFF)",
                  boxShadow: d.tPlans.ring,
                  textAlign: "left",
                  cursor: "pointer",
                }}
              >
                ...
                >
                  <svg
                    ...
                    strokeWidth="1.5"
                  >
                    <path d="M4 1.5h4.8l2.7 2.7v9.3H4z"></path>
                    <path d="M8.8 1.5v2.7h2.7"></path>
                  </svg>
                </span>{" "}
              ...
              <button
                ...
                style={{
                  ...
                  padding: "14px 16px",
                  borderRadius: "14px",
                  border: `1px solid ${d.tEvalsT.bd}`,
                  background: "var(--cd,#FFFFFF)",
                  boxShadow: d.tEvalsT.ring,
                  textAlign: "left",
                  cursor: "pointer",
                }}
              >
              ...
              <button
                ...
                style={{
                  ...
                  padding: "14px 16px",
                  borderRadius: "14px",
                  border: `1px solid ${d.tBehind.bd}`,
                  background: "var(--cd,#FFFFFF)",
                  boxShadow: d.tBehind.ring,
                  textAlign: "left",
                  cursor: "pointer",
                }}
              >
              ...
              <button
                ...
                style={{
                  ...
                  padding: "14px 16px",
                  borderRadius: "14px",
                  border: `1px solid ${d.tDoneE.bd}`,
                  background: "var(--cd,#FFFFFF)",
                  boxShadow: d.tDoneE.ring,
                  textAlign: "left",
                  cursor: "pointer",
                }}
              >
                    ...
                    <Fragment key={rIndex}>
                      ...
                      <div
                        style={{
                          ...
                          borderRadius: "12px",
                          background:
                            "linear-gradient(120deg,var(--sw,#FFEAE6) 0%,var(--cd,#FFFFFF) 55%)",
                          boxShadow: "0 1px 2px rgba(13,16,32,.03)",
                          padding: "18px 20px",
                        }}
                      >
                        {" "}
              ...
              <>
                ...
                >
                  ...
                  <div
                    style={{
                      display: "grid",
                      gridTemplateColumns: "minmax(160px,1.2fr) 90px 170px 130px 120px 90px",
                      gap: "8px",
                      alignItems: "center",
                      padding: "0 14px",
                      height: "36px",
                        ...
                        >
                          <span
                            style={{
                              ...
                              height: "5px",
                              borderRadius: "50%",
                              background: ev.paceFg,
                            }}
                          ></span>
                          {ev.pace}
                        </span>{" "}
                        <span
                          style={{ font: "400 11.5px 'IBM Plex Mono',monospace", color: ev.biasFg }}
                          title="Average score given, relative to the panel"
                        >
                          {ev.bias}
                        </span>{" "}
                        {ev.canRemind ? (
                  ...
                  >
                    ...
                    >
                      {d.evaluatorCount} on the team can score
                    </span>{" "}
                    <span
                      style={{
                        font: "400 11px 'IBM Plex Sans',sans-serif",
                    ...
                    >
                      “vs panel avg” compares each person’s average score with everyone else’s
                    </span>{" "}
                  </div>{" "}
                </div>{" "}
              </>
            ...
            <Fragment key={tIndex}>
              ...
              <div
                style={{
                  ...
                  gap: "10px",
                  background: "var(--cd,#FFFFFF)",
                  border: "1px solid var(--sg,#E04E4E)",
                  borderLeft: "4px solid var(--sg,#E04E4E)",
                  borderRadius: "10px",
                  padding: "12px 14px",
