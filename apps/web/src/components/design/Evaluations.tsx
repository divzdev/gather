...
export type EvaluationsData = {
  ...
  readonly rounds: readonly {
    ...
    readonly total: React.ReactNode;
      readonly rubric: React.ReactNode;
  }[];
  readonly soBias: {
    readonly fg: string;
