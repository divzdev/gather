...
export type MessagesData = {
  ...
  readonly icsNote: React.ReactNode;
...
export function Messages({ d }: { d: MessagesData }) {
  return (
    <DesignMotion css={HOVER_CSS}>
      ...
      >
        {" "}
        <Rail active="Messages" style={{ height: "100%", minHeight: "0" }} />{" "}
        <div
            ...
            {d.tabCompose ? (
              <>
                ...
                >
                  ...
                  >
                    nothing sends until step 3, ever
                  </span>{" "}
                  <div
                    style={{
                      display: "flex",
                        ...
                        <Fragment key={tbIndex}>
                          ...
                          <button
                            ...
                            style={{
                              ...
                              background: tb.bg,
                              color: tb.fg,
                              font: `${tb.wt} 12px 'IBM Plex Sans',sans-serif`,
                              whiteSpace: "nowrap",
                              boxShadow: tb.sh,
                            }}
                          >
                ...
                >
                  Pick an audience, write once with variables, preview against a real speaker.
                  Sending is always the explicit last step.
                </div>{" "}
                <div
                  style={{
                    display: "grid",
                ...
                >
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
                    ...
                    >
                      ...
                      >
                        {" "}
                        {(d.tpls ?? []).map((tp, tpIndex) => (
                          <Fragment key={tpIndex}>
                            {" "}
                            <button
                              onClick={tp.on}
                              style={{
                      ...
                      >
                        ...
                        {/* Was "click a variable to insert it", describing a
                            feature this screen no longer has. Both fields are
                            readOnly and come from the API — the same strings the
                            send path uses, so the preview cannot drift from what
                            goes out. Say that instead. */}
                        <span
                          style={{
                        ...
                        >
                          written per recipient · step through them below
                        </span>
                      </div>{" "}
                      <div
                        style={{
                    ...
                    >
                      ...
                      >
                        ...
                        {d.sendNote} Delivery lands in the outbox with per-recipient status.
                      </div>{" "}
                      {/* The gate on the most dangerous action in the product.
                          It was a 14px glyph — the smallest control on a screen
                          whose one button emails every speaker at once. */}
                      <button
                        role="checkbox"
                        aria-checked={d.ckOn}
                        onClick={d.togCk}
                      ...
                      {/* One button, because there is one decision. "Send a test
                          to me" sat here at equal weight and only ever toasted
                          that it was not built; the preview beside this shows
                          the real message for a real recipient, which answers
                  ...
                  <div>
                    ...
                    <div style={{ position: "sticky", top: "0" }}>
                      ...
                      >
                        Variables fill from each real recipient. A variable with no value flags
                        before send.
                      </div>{" "}
                    </div>{" "}
                  </div>{" "}
            ...
            {d.tabOutbox ? (
              <>
                ...
                >
                  ...
                  >
                    every send, with delivery truth
                  </span>{" "}
                  <div
                    style={{
                      display: "flex",
                ...
                >
                  ...
                  <button
                    ...
                    style={{
                      ...
                      padding: "14px 16px",
                      borderRadius: "14px",
                      border: `1px solid ${d.tAllM.bd}`,
                      background: "var(--cd,#FFFFFF)",
                      boxShadow: d.tAllM.ring,
                      textAlign: "left",
                      cursor: "pointer",
                    }}
                  >
                    ...
                    >
                      <svg
                        ...
                        strokeWidth="1.5"
                      >
                        <rect x="1.5" y="3" width="12" height="9" rx="2"></rect>
                        <path d="M2.2 4.2l5.3 4.2 5.3-4.2"></path>
                      </svg>
                    </span>{" "}
                  ...
                  <button
                    ...
                    style={{
                      ...
                      padding: "14px 16px",
                      borderRadius: "14px",
                      border: `1px solid ${d.tSent.bd}`,
                      background: "var(--cd,#FFFFFF)",
                      boxShadow: d.tSent.ring,
                      textAlign: "left",
                      cursor: "pointer",
                    }}
                  >
                  ...
                  <button
                    ...
                    style={{
                      ...
                      padding: "14px 16px",
                      borderRadius: "14px",
                      border: `1px solid ${d.tQd.bd}`,
                      background: "var(--cd,#FFFFFF)",
                      boxShadow: d.tQd.ring,
                      textAlign: "left",
                      cursor: "pointer",
                    }}
                  >
                  ...
                  <button
                    ...
                    style={{
                      ...
                      padding: "14px 16px",
                      borderRadius: "14px",
                      border: `1px solid ${d.tBn.bd}`,
                      background: "var(--cd,#FFFFFF)",
                      boxShadow: d.tBn.ring,
                      textAlign: "left",
                      cursor: "pointer",
                    }}
                  >
                ...
                {d.hasBounce ? (
                  <>
                    ...
                    >
                      ...
                      >
                        <span style={{ fontWeight: "600", color: "var(--cn,#D8432B)" }}>
                          {d.bounceN} bounced.
                        </span>{" "}
                        These speakers have not received their message. Bounces are silent failures
                        in most tools.
                      </span>{" "}
                      <button
                        onClick={d.resendAll}
                ...
                >
                  ...
                  <div
                    style={{
                      display: "grid",
                      gridTemplateColumns: "minmax(150px,1fr) minmax(200px,1.4fr) 130px 90px 80px",
                      gap: "8px",
                      alignItems: "center",
                      padding: "0 12px",
                      height: "34px",
                    ...
                    <Fragment key={mIndex}>
                      ...
                      <div
                        style={{
                          display: "grid",
                          gridTemplateColumns:
                            "minmax(150px,1fr) minmax(200px,1.4fr) 130px 90px 80px",
                          gap: "8px",
                          alignItems: "center",
                          padding: "0 12px",
                          height: "38px",
            ...
            {d.tabTpl ? (
              <>
                ...
                >
                  ...
                  >
                    one verb per template, previewed against a real speaker
                  </span>{" "}
                  <div
                    style={{
                      display: "flex",
