...
export type SpeakersData = {
  ...
  readonly statusError: React.ReactNode | null;
  ...
  readonly toggleStatusMenu: (event: React.SyntheticEvent) => void;
  readonly closeStatusMenu: (event: React.SyntheticEvent) => void;
  readonly o: {
...
export function Speakers({ d }: { d: SpeakersData }) {
  return (
    <DesignMotion css={HOVER_CSS}>
      ...
      >
        {" "}
        <Rail active="Speakers" style={{ height: "100%", minHeight: "0" }} />{" "}
        <div
        ...
        >
          ...
          >
            ...
            >
              ...
              <button
                ...
                style={{
                  ...
                  padding: "14px 16px",
                  borderRadius: "14px",
                  border: `1px solid ${d.tAllS.bd}`,
                  background: "var(--cd,#FFFFFF)",
                  boxShadow: d.tAllS.ring,
                  textAlign: "left",
                  cursor: "pointer",
                }}
              >
                ...
                >
                  <svg
                    ...
                    strokeWidth="1.5"
                  >
                    <circle cx="7.5" cy="4.8" r="2.5"></circle>
                    <path d="M2.8 12.8c.6-2.5 2.4-3.9 4.7-3.9s4.1 1.4 4.7 3.9"></path>
                  </svg>
                </span>{" "}
              ...
              <button
                ...
                style={{
                  ...
                  padding: "14px 16px",
                  borderRadius: "14px",
                  border: `1px solid ${d.tMiss.bd}`,
                  background: "var(--cd,#FFFFFF)",
                  boxShadow: d.tMiss.ring,
                  textAlign: "left",
                  cursor: "pointer",
                }}
              >
                ...
                >
                  ...
                  >
                    ...
                    <circle cx="7.5" cy="7.5" r="1.6" fill="currentColor" stroke="none"></circle>
                  </svg>
                </span>{" "}
                <span style={{ minWidth: "0" }}>
                  <span
              ...
              <button
                ...
                style={{
                  ...
                  padding: "14px 16px",
                  borderRadius: "14px",
                  border: `1px solid ${d.tOdS.bd}`,
                  background: "var(--cd,#FFFFFF)",
                  boxShadow: d.tOdS.ring,
                  textAlign: "left",
                  cursor: "pointer",
                }}
              >
              ...
              <button
                ...
                style={{
                  ...
                  padding: "14px 16px",
                  borderRadius: "14px",
                  border: `1px solid ${d.tDoneS.bd}`,
                  background: "var(--cd,#FFFFFF)",
                  boxShadow: d.tDoneS.ring,
                  textAlign: "left",
                  cursor: "pointer",
                }}
              >
            ...
            >
              {" "}
              <input
                aria-label="Filter by name or company. Press /"
                value={d.q}
                onChange={d.onQ}
                placeholder="Filter by name or company. Press /"
                style={{
                  height: "32px",
                  width: "260px",
                  padding: "0 11px",
              ...
              <div style={{ width: "1px", height: "20px", background: "var(--ln,#E1E7E9)" }}></div>{" "}
              {(d.missChips ?? []).map((mc, mcIndex) => (
                <Fragment key={mcIndex}>
                  {" "}
                  <button
                    onClick={mc.on}
                    style={{
            ...
            >
              ...
              <div
                style={{
                  display: "grid",
                  gridTemplateColumns:
                    "36px minmax(180px,1.2fr) 110px 60px 150px minmax(160px,1fr) 90px 92px",
                  gap: "8px",
                  alignItems: "center",
                  padding: "0 12px",
                  height: "34px",
              ...
              >
                ...
                <button
                  className="dch-f129dbea"
                  onClick={d.soMissing.on}
                  title="Sort by missing"
                  style={{
                    display: "inline-flex",
                    alignItems: "center",
                    gap: "4px",
              ...
              {(d.rows ?? []).map((r, rIndex) => (
                <Fragment key={rIndex}>
                  ...
                  >
                    ...
                    >
                      <span
                        style={{
                          ...
                          alignItems: "center",
                          justifyContent: "center",
                          font: "600 8.5px 'IBM Plex Sans Condensed',sans-serif",
                          color: "var(--i3,#6B7B84)",
                          flex: "none",
                        }}
                      >
                    ...
                    <span style={{ font: "400 11px 'IBM Plex Mono',monospace", color: r.seenFg }}>
                      {r.seen}
                    </span>{" "}
                    <span
                      style={{
              ...
              <div style={{ padding: "0 12px" }}>{d.pager}</div>{" "}
              <div
                style={{
                  display: "flex",
                  alignItems: "center",
              ...
              >
                ...
                <span
                  style={{ font: "400 11px 'IBM Plex Mono',monospace", color: "var(--i4,#99A6AD)" }}
                >
                  j / k to move · x selects · Enter opens
                </span>{" "}
              </div>{" "}
            </div>{" "}
            {d.hasSel ? (
              <>
                ...
                >
                  ...
                  >
                    ...
                    <div
                      style={{ width: "1px", height: "18px", background: "var(--ln,#E1E7E9)" }}
                    ></div>{" "}
                    <button
                      onClick={d.bulkNudge}
                      style={{
        ...
        {d.open ? (
          <>
            ...
            >
              {" "}
              <div style={{ padding: "18px 24px 0", borderBottom: "1px solid var(--ln,#E1E7E9)" }}>
                {" "}
                <div
                  style={{
                    display: "flex",
                ...
                >
                  ...
                  {d.o.nextLabel !== null ? (
                    <>
                      {" "}
                      <button
                        onClick={d.o.onAdvance}
                        disabled={d.statusPending}
                        style={{
                          ...
                          cursor: d.statusPending ? "default" : "pointer",
                          opacity: d.statusPending ? 0.6 : 1,
                        }}
                      >
                        {d.statusPending ? "Updating…" : d.o.nextLabel}
                      </button>{" "}
                    </>
                  ) : null}{" "}
                  <div style={{ position: "relative" }}>
                    ...
                    {d.statusMenuOpen ? (
                      <>
                        ...
                        >
                          {" "}
                          {(d.statusOptions ?? []).map((so, soIndex) => (
                            <Fragment key={soIndex}>
                              {" "}
                              <button
                                onClick={so.on}
                                disabled={so.current || d.statusPending}
                                style={{
                                  display: "flex",
                                  alignItems: "center",
                                  gap: "10px",
                                  ...
                                  padding: "8px 10px",
                                  borderRadius: "8px",
                                  background: so.current ? "var(--sk,#EDF1F2)" : "none",
                                  border: "none",
                                  textAlign: "left",
                                  cursor: so.current ? "default" : "pointer",
                                }}
                              >
                                <span
                                  style={{
                    ...
                    {(d.o.tasks ?? []).map((tk, tkIndex) => (
                      <Fragment key={tkIndex}>
                        ...
                        >
                          ...
                          <span
                            style={{ font: "400 11px 'IBM Plex Mono',monospace", color: tk.dueFg }}
                          >
                            {tk.due}
                          </span>{" "}
                          {tk.canDo ? (
                  ...
                  <>
                    ...
                    {d.o.noFiles ? (
                      <>
                        ...
                        >
                          Nothing uploaded yet. Their portal has the drop zone.
                        </div>{" "}
                      </>
                    ) : null}{" "}
                  </>
                ...
                {d.tabNotes ? (
                  <>
                    ...
                    >
                      ...
                      >
                        Internal. Never speaker-visible.
                      </div>{" "}
                      {(d.o.notes ?? []).map((nn, nnIndex) => (
                        <Fragment key={nnIndex}>
                          {" "}
