...
/* GENERATED from Sessions.dc.html by tools/dc2tsx.py. Do not hand-edit — change the
...
export type SessionsData = {
  ...
  readonly dStamp: React.ReactNode;
  readonly dTitle: React.ReactNode;
  readonly detFg: string;
  readonly detUl: string;
  readonly detWt: string;
  readonly doCsv: (event: React.SyntheticEvent) => void;
  readonly doFiles: (event: React.SyntheticEvent) => void;
  readonly doImport: (event: React.SyntheticEvent) => void;
  readonly doXlsx: (event: React.SyntheticEvent) => void;
  readonly drawer: boolean;
  readonly empty: boolean;
  /** Three different claims about the table, so they can stop looking like one. */
  readonly loading: boolean;
  readonly loadError: React.ReactNode;
  readonly onRetry: (event: React.SyntheticEvent) => void;
  readonly f: {
    readonly cap: string;
  ...
  /** Hand-bound: the track and format selects listed the prototype's tracks —
   *  Agents, Evals, Retrieval — for every event that has never had them. */
  readonly trackOpts: readonly { readonly v: string; readonly l: React.ReactNode }[];
  readonly formatOpts: readonly { readonly v: string; readonly l: React.ReactNode }[];
  /** The event's real rooms — this used to be four fixture names
  ...
  readonly onLevel: (event: React.SyntheticEvent) => void;
  readonly onLanguage: (event: React.SyntheticEvent) => void;
  readonly onTags: (event: React.SyntheticEvent) => void;
  readonly fBd: string;
  readonly fBg: string;
  readonly fCount: React.ReactNode;
  readonly fFg: string;
  readonly fFmtOpts: readonly {
  ...
  readonly impClose: (event: React.SyntheticEvent) => void;
  readonly impCount: React.ReactNode;
  readonly impErr: React.ReactNode;
  readonly impErrShow: boolean;
  readonly impExample: (event: React.SyntheticEvent) => void;
  readonly impFile: (event: React.SyntheticEvent) => void;
  readonly impGo: (event: React.SyntheticEvent) => void;
  readonly impGoBg: string;
  readonly impGoFg: string;
  readonly impLabel: React.ReactNode;
  readonly impRaw: string;
  readonly impReady: boolean;
  readonly impRows: readonly {
  ...
  readonly onCap: (event: React.SyntheticEvent) => void;
  readonly onDesc: (event: React.SyntheticEvent) => void;
  readonly onDet: boolean;
  readonly onFmt: (event: React.SyntheticEvent) => void;
  readonly onImpRaw: (event: React.SyntheticEvent) => void;
  ...
  readonly optOpen: boolean;
  readonly parFg: string;
  readonly parUl: string;
  readonly parWt: string;
  readonly partDraft: string;
  readonly partN: React.ReactNode;
  readonly parts: readonly {
    readonly ini: React.ReactNode;
    readonly n: React.ReactNode;
    readonly onX: (event: React.SyntheticEvent) => void;
    readonly role: React.ReactNode;
  }[];
  readonly q: string;
  ...
  readonly togOpt: (event: React.SyntheticEvent) => void;
...
@keyframes dch-pulse{0%,100%{opacity:.4}50%{opacity:.85}}
.dch-skel{animation:dch-pulse 1.4s ease-in-out infinite}`;

export function Sessions({ d }: { d: SessionsData }) {
  return (
    <DesignMotion css={HOVER_CSS}>
      <div
        data-screen-label="Sessions"
        style={{
          display: "grid",
      ...
      >
        {" "}
        <Rail active="Sessions" style={{ height: "100%", minHeight: "0" }} />{" "}
        <div
        ...
        >
          ...
          >
            ...
            <Link
              ...
              style={{
                display: "inline-flex",
                alignItems: "center",
                minHeight: "var(--control-h-sm, 36px)",
                padding: "0 2px",
            ...
            <span style={{ color: "var(--i4,#99A6AD)" }}>·</span>{" "}
            <span
              style={{
                display: "inline-flex",
                alignItems: "center",
            ...
            >
              a session = an accepted talk with logistics
            </span>{" "}
          </div>{" "}
          <div style={{ flex: "1", overflowY: "auto", padding: "20px 28px 80px" }}>
            ...
            >
              ...
              >
                the program library · every queue in one place
              </span>{" "}
              <div
                style={{
                  display: "flex",
                    ...
                    <>
                      ...
                      <div
                        style={{
                          ...
                          borderRadius: "10px",
                          boxShadow: "0 12px 32px rgba(13,16,32,.18)",
                          padding: "5px",
                          zIndex: "40",
                        }}
                      >
                        ...
                        >
                          Set track · current view
                        </button>{" "}
                        <button
                          className="dch-c4989b43"
                          onClick={d.bulkFormat}
                          style={{
                            width: "100%",
                            textAlign: "left",
                            minHeight: "36px",
                        ...
                        >
                          Set format · current view
                        </button>{" "}
                        <button
                          className="dch-c4989b43"
                          onClick={d.bulkApproval}
                          style={{
                            width: "100%",
                            textAlign: "left",
                            minHeight: "36px",
            ...
            >
              ...
              <button
                ...
                style={{
                  ...
                  padding: "14px 16px",
                  borderRadius: "14px",
                  border: `1px solid ${d.tAll.bd}`,
                  background: "var(--cd,#FFFFFF)",
                  boxShadow: d.tAll.ring,
                  textAlign: "left",
                  cursor: "pointer",
                }}
              >
                ...
                >
                  <svg width="14" height="14" viewBox="0 0 15 15" fill="currentColor">
                    <rect x="1.5" y="2" width="12" height="2.4" rx="1.2"></rect>
                    <rect x="1.5" y="6.3" width="12" height="2.4" rx="1.2"></rect>
                    <rect x="1.5" y="10.6" width="8" height="2.4" rx="1.2"></rect>
                  </svg>
                </span>{" "}
              ...
              <button
                ...
                style={{
                  ...
                  padding: "14px 16px",
                  borderRadius: "14px",
                  border: `1px solid ${d.tAcc.bd}`,
                  background: "var(--cd,#FFFFFF)",
                  boxShadow: d.tAcc.ring,
                  textAlign: "left",
                  cursor: "pointer",
                }}
              >
                ...
                >
                  ...
                  >
                    ...
                    <path d="M4.8 7.8l1.8 1.8 3.6-4"></path>
                  </svg>
                </span>{" "}
                <span style={{ minWidth: "0" }}>
                  <span
              ...
              <button
                ...
                style={{
                  ...
                  padding: "14px 16px",
                  borderRadius: "14px",
                  border: `1px solid ${d.tQu.bd}`,
                  background: "var(--cd,#FFFFFF)",
                  boxShadow: d.tQu.ring,
                  textAlign: "left",
                  cursor: "pointer",
                }}
              >
                ...
                >
                  <svg
                    ...
                    strokeWidth="1.5"
                  >
                    <rect x="1.5" y="1.5" width="12" height="12" rx="3"></rect>
                    <path d="M4.6 7.8l2 2 3.8-4.2"></path>
                  </svg>
                </span>{" "}
                <span style={{ minWidth: "0" }}>
                  <span
              ...
              <button
                ...
                style={{
                  ...
                  padding: "14px 16px",
                  borderRadius: "14px",
                  border: `1px solid ${d.tPe.bd}`,
                  background: "var(--cd,#FFFFFF)",
                  boxShadow: d.tPe.ring,
                  textAlign: "left",
                  cursor: "pointer",
                }}
              >
                ...
                >
                  ...
                  >
                    <circle cx="7.5" cy="7.5" r="6"></circle>
                    <path d="M7.5 4.3v3.4l2.3 1.4"></path>
                  </svg>
                </span>{" "}
                <span style={{ minWidth: "0" }}>
                  <span
            ...
            >
              {" "}
              <input
                aria-label="Filter by title or speaker"
                value={d.q}
                onChange={d.onQ}
              ...
              <div style={{ position: "relative" }}>
                ...
                >
                  <svg
                    ...
                    style={{ flex: "none" }}
                  >
                    <path d="M1.5 2.5h12l-4.6 5.4v4.2l-2.8 1.4V7.9L1.5 2.5z"></path>
                  </svg>
                  Filter{d.fCount}
                </button>{" "}
                {d.fPopOn ? (
            ...
            >
              ...
              <div
                style={{
                  display: "grid",
                  gridTemplateColumns:
                    "64px minmax(220px,1.6fr) minmax(130px,1fr) 120px 110px minmax(170px,1.1fr) 118px",
                  gap: "8px",
                  alignItems: "center",
                  padding: "0 14px",
                  height: "34px",
              ...
              >
                ...
                <button
                  className="dch-f129dbea"
                  onClick={d.soSched.on}
                  title="Sort by scheduled"
                  style={{
                    display: "inline-flex",
                    alignItems: "center",
                    gap: "4px",
              ...
              {d.loading ? (
                <>
                  ...
                  {[0, 1, 2, 3, 4, 5].map((skelIndex) => (
                    ...
                    >
                      {[36, 88, 66, 52, 44, 78, 60].map((w, cellIndex) => (
                        <span
                          key={cellIndex}
                          className="dch-skel"
                          style={{
              ...
              <div style={{ padding: "0 14px" }}>{d.pager}</div>{" "}
              <div
                style={{
                  display: "flex",
                  alignItems: "center",
              ...
              >
                ...
                <span
                  style={{ font: "400 11px 'IBM Plex Mono',monospace", color: "var(--i4,#99A6AD)" }}
                >
                  click a row to edit · Esc closes
                </span>{" "}
              </div>{" "}
            </div>{" "}
          </div>{" "}
        ...
        {d.drawer ? (
          <>
            ...
            >
              {" "}
              <div style={{ padding: "16px 22px 0", borderBottom: "1px solid var(--ln,#E1E7E9)" }}>
                {" "}
                <div
                  style={{
                    display: "flex",
                ...
                <div style={{ display: "flex", gap: "2px" }}>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      border: "none",
                      background: "none",
                      font: `${d.detWt} 12.5px 'IBM Plex Sans',sans-serif`,
                      color: d.detFg,
                      borderBottom: `2px solid ${d.detUl}`,
                    }}
                  >
                    Details
                  </button>{" "}
                  <button
                    ...
                    style={{
                      ...
                      border: "none",
                      background: "none",
                      font: `${d.parWt} 12.5px 'IBM Plex Sans',sans-serif`,
                      color: d.parFg,
                      borderBottom: `2px solid ${d.parUl}`,
                    }}
                  >
                    Participants · {d.partN}
                  </button>{" "}
                </div>{" "}
              </div>{" "}
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
                      ...
                      <div>
                        ...
                        >
                          ...
                          >
                            Title <span style={{ color: "var(--cn,#D8432B)" }}>*</span>
                          </span>
                          <span
                            style={{
                              font: "400 11px 'IBM Plex Mono',monospace",
                      ...
                      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px" }}>
                        ...
                        <div>
                          ...
                          <div
                            title="Set by placement — schedule or clear the room below to change it"
                            style={{
                              width: "100%",
                              boxSizing: "border-box",
                              height: "40px",
                        ...
                        <div>
                          ...
                          <input
                            id="sessions-language"
                            value={d.f.language}
                            onChange={d.onLanguage}
                            placeholder="English"
                            style={{
                              width: "100%",
                              boxSizing: "border-box",
                        ...
                        <div style={{ gridColumn: "1/-1" }}>
                          ...
                          <input
                            ...
                            value={d.f.tags}
                            onChange={d.onTags}
                            placeholder="kubernetes, cost, war story"
                            style={{
                              width: "100%",
                              boxSizing: "border-box",
                              height: "40px",
                          ...
                          >
                            Comma separated. The public schedule builds its filters from these.
                          </div>{" "}
                        </div>{" "}
                        <div>
                          {" "}
                      ...
                      {d.placementErr ? (
                        <div
                          ...
                          style={{
                            ...
                            borderRadius: "8px",
                            padding: "9px 13px",
                            font: "500 12px/18px 'IBM Plex Sans',sans-serif",
                            color: "var(--cn,#D8432B)",
                          }}
                        >
                          {d.placementErr}
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          onChange={d.onDesc}
                          rows={5}
                          placeholder="Shown on the public schedule and embeds"
                          style={{
                            width: "100%",
                            boxSizing: "border-box",
                            padding: "10px 12px",
                      ...
                      >
                        Room and start time save here or from the agenda grid — same record either
                        way. The start time must fall on one of the event&rsquo;s days; clearing the
                        room drops it back into the unscheduled tray. Status follows placement and
                  ...
                  <>
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
                          ...
                          >
                            ...
                            <span
                              style={{
                                ...
                                alignItems: "center",
                                justifyContent: "center",
                                font: "600 9px 'IBM Plex Sans Condensed',sans-serif",
                                color: "var(--i3,#6B7B84)",
                                flex: "none",
                              }}
                            >
                      ...
                      <div style={{ display: "flex", gap: "7px" }}>
                        {" "}
                        <input
                          aria-label="Add by name, role defaults to Speaker"
                          value={d.partDraft}
                          onChange={d.onPartDraft}
                          placeholder="Add by name, role defaults to Speaker"
                          style={{
                            flex: "1",
                            boxSizing: "border-box",
                            height: "40px",
                      ...
                      >
                        Speaker role: 1 to 4 per session, from the CFP form rules. Each added person
                        gets a portal on acceptance.
                      </div>{" "}
                    </div>{" "}
                  </>
                ) : null}{" "}
              ...
              >
                ...
                <button
                  ...
                  style={{
                    ...
                    color: "var(--bf,#331313)",
                    font: "600 13px 'IBM Plex Sans',sans-serif",
                    opacity: d.saveDisabled ? 0.6 : 1,
                    cursor: d.saveDisabled ? "default" : "pointer",
                  }}
                >
                  {d.saveLabel}
                </button>{" "}
            ...
            >
              ...
              <div
                style={{
                  ...
                  border: "1px solid var(--ln,#E1E7E9)",
                  borderRadius: "14px",
                  boxShadow: "0 24px 64px rgba(13,16,32,.28)",
                  padding: "20px 22px",
                }}
              >
                {" "}
                ...
                >
                  Paste CSV or choose a file. The first row is the header. Nothing writes until you
                  confirm below.
                </div>{" "}
                <div
                  style={{
                ...
                <textarea
                  ...
                  rows={6}
                  placeholder={
                    'title,speakers,track,format\n"My session title","Ada Okoye; Sam Reyes",Agents,30 min talk'
                  }
                  style={{
                    width: "100%",
                    boxSizing: "border-box",
                  ...
                  <>
                    ...
                    >
                      ...
                      <div
                        style={{
                          display: "grid",
                          gridTemplateColumns: "minmax(160px,1.4fr) minmax(120px,1fr) 110px 110px",
                          gap: "8px",
                          padding: "0 12px",
                          height: "30px",
                          alignItems: "center",
                        ...
                        <Fragment key={irIndex}>
                          ...
                          <div
                            style={{
                              display: "grid",
                              gridTemplateColumns:
                                "minmax(160px,1.4fr) minmax(120px,1fr) 110px 110px",
                              gap: "8px",
                              padding: "0 12px",
                              height: "34px",
                              alignItems: "center",
                      ...
                      >
                        ...
                        >
                          unknown tracks keep their name, shown uncolored
                        </span>{" "}
                      </div>{" "}
                    </div>{" "}
                  </>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                  ...
                  >
                    imports land as drafts, never as accepted
                  </span>{" "}
                </div>{" "}
              </div>{" "}
            </div>{" "}
