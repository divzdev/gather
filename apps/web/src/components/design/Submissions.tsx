...
/* GENERATED from Submissions.dc.html by tools/dc2tsx.py. Do not hand-edit — change the
...
export type SubmissionsData = {
  ...
  readonly dAcc: (event: React.SyntheticEvent) => void;
  readonly dRej: (event: React.SyntheticEvent) => void;
  readonly dWait: (event: React.SyntheticEvent) => void;
