...
export function Tasks({ d }: { d: TasksData }) {
  return (
    <DesignMotion css={HOVER_CSS}>
      <div
        data-screen-label="Task dashboard"
        style={{
          display: "grid",
      ...
      >
        {" "}
        <Rail active="Tasks" style={{ height: "100%", minHeight: "0" }} />{" "}
        <div
        ...
        >
          ...
          <div style={{ flex: "1", overflowY: "auto", padding: "20px 28px 80px" }}>
            ...
            >
              ...
              >
                who owes you what, latest first
              </span>{" "}
              <div style={{ flex: "1" }}></div>{" "}
              <div
                style={{
              ...
              >
                ...
                <button
                  ...
                  style={{
                    ...
                    borderRadius: "999px",
                    border: "none",
                    background: d.vTaskBg,
                    color: d.vTaskFg,
                    font: `${d.vTaskWt} 12px 'IBM Plex Sans',sans-serif`,
                    whiteSpace: "nowrap",
                    boxShadow: d.vTaskSh,
                  }}
                >
                ...
                <button
                  ...
                  style={{
                    ...
                    background: d.vSpBg,
                    color: d.vSpFg,
                    font: `${d.vSpWt} 12px 'IBM Plex Sans',sans-serif`,
                    whiteSpace: "nowrap",
                    boxShadow: d.vSpSh,
                  }}
                >
            ...
            >
              ...
              <button
                ...
                style={{
                  ...
                  padding: "14px 16px",
                  borderRadius: "14px",
                  border: `1px solid ${d.tOpen.bd}`,
                  background: "var(--cd,#FFFFFF)",
                  boxShadow: d.tOpen.ring,
                  textAlign: "left",
                  cursor: "pointer",
                }}
              >
              ...
              <button
                ...
                style={{
                  ...
                  padding: "14px 16px",
                  borderRadius: "14px",
                  border: `1px solid ${d.tOdT.bd}`,
                  background: "var(--cd,#FFFFFF)",
                  boxShadow: d.tOdT.ring,
                  textAlign: "left",
                  cursor: "pointer",
                }}
              >
              ...
              <button
                ...
                style={{
                  ...
                  padding: "14px 16px",
                  borderRadius: "14px",
                  border: `1px solid ${d.tSpk.bd}`,
                  background: "var(--cd,#FFFFFF)",
                  boxShadow: d.tSpk.ring,
                  textAlign: "left",
                  cursor: "pointer",
                }}
              >
              ...
              <button
                ...
                style={{
                  ...
                  padding: "14px 16px",
                  borderRadius: "14px",
                  border: `1px solid ${d.tDoneT.bd}`,
                  background: "var(--cd,#FFFFFF)",
                  boxShadow: d.tDoneT.ring,
                  textAlign: "left",
                  cursor: "pointer",
                }}
              >
            ...
            <div style={{ display: "flex", gap: "8px", flexWrap: "wrap", marginBottom: "18px" }}>
              {" "}
              {(d.summary ?? []).map((sm, smIndex) => (
                <Fragment key={smIndex}>
                  {" "}
                  <button
                    onClick={sm.on}
                    style={{
            ...
            {d.allClear ? (
              <>
                {" "}
                {/* Success green means "everything is accounted for". An event
                    that has never been set up is not an achievement, so it gets
                    the neutral surface — colour only ever means state. */}
                <div
                  style={{
                    border: `1px solid ${d.allClearBd}`,
                    borderRadius: "14px",
                    background: d.allClearBg,
                    padding: "20px 22px",
                    font: "500 13.5px/1.55 'IBM Plex Sans',sans-serif",
                    color: d.allClearFg,
                  }}
                >
                  {d.allClearNote}
