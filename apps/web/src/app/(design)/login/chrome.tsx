...
export function Mark({ size = 26 }: { size?: number }) {
  return (
    <svg viewBox="0 0 24 24" style={{ width: size, height: size, borderRadius: size / 3.7 }}>
      ...
      <circle cx="14.7" cy="14.7" r="5.7" fill="#8A8DF5" />
      <circle cx="6.3" cy="6.3" r="2.3" fill="#141417" />
      <circle cx="14.4" cy="5.4" r="1.5" fill="#141417" />
      <circle cx="5.4" cy="14.4" r="1.5" fill="#141417" />
    </svg>
  );
}
